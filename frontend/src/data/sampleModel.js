export const sampleModel = {
  ...
  tabs: [
    { id: "physical", label: "Physical", active: true },
    { id: "logical", label: "Logical", active: false },
    { id: "entity-definition", label: "EntityDefinition", active: false },
    { id: "entity", label: "Entity", active: false },
    { id: "physical-index", label: "PhysicalIndex", active: false }
  ],
  entities: [
    {
      id: "store",
